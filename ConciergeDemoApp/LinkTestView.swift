    ...
    var body: some View {
        NavigationView {
            List {
                ...
                Section {
                    Text("Tap a URL to route it through ConciergeLinkHandler.handleURL and test which handler is invoked.\n\nApple Maps links test universal link behavior — Maps is preinstalled on the simulator, so these should be claimed as universal links.")
                        .font(.footnote)
            ...
            .navigationTitle("Link Handler Test")
        }
        .tint(.primary)
    }
