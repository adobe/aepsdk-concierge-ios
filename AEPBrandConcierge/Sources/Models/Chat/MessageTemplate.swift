...
/// Defines the visual template for a message in the chat.
public enum MessageTemplate {
    case welcomeHeader(title: String, body: String)
    case welcomePromptSuggestion(imageSource: ImageSource, text: String, background: Color)
    ...
    case productCard(imageSource: ImageSource, title: String, body: String, primaryButton: ActionButton? = nil, secondaryButton: ActionButton? = nil)
    case carouselGroup([Message])
    case promptSuggestion(text: String)
    case divider
}

/// Represents an image source that can be local or remote.
