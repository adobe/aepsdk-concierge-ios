...
public enum CSSKeyMapper {
    ...
    private static let cssToAssignmentMap: [String: Assignment] = [
        ...
        "product-card-text-spacing": { cssValue, theme in theme.layout.productCardTextSpacing = CSSValueConverter.parsePxValue(cssValue) ?? 6 },
        "product-card-title-subtitle-spacing": { cssValue, theme in theme.layout.productCardTitleSubtitleSpacing = CSSValueConverter.parsePxValue(cssValue) ?? 6 },
        "product-card-section-spacing": { cssValue, theme in theme.layout.productCardSectionSpacing = CSSValueConverter.parsePxValue(cssValue) ?? 6 },
        "product-card-price-spacing": { cssValue, theme in theme.layout.productCardPriceSpacing = CSSValueConverter.parsePxValue(cssValue) ?? 6 },
